    ...
    <div className="container mx-auto mt-6 p-4">
      ...
      <div className="flex flex-col md:flex-row  mb-4">
        ...
        <div className="md:w-1/2">
          <img src={serviceDetails.image} alt="Product" className="max-w-full h-auto" />
        </div>

        {/* Right side - Product Details */}
        <div className="md:w-1/2 mt-4 md:mt-0 md:ml-4 border p-4">
        <h1 className="text-2xl font-bold mb-2">{serviceDetails.productName}</h1>
          <h2 className="text-xl font-semibold mb-4">{serviceDetails.brand}</h2>
          <p className="text-gray-700 mb-2">Model Number: {serviceDetails.modelNumber}</p>
      ...
      {/* Bottom Section */}
      <div className="mt-4">
        <p className="text-gray-700 mb-4">{serviceDetails.productDescription}</p>

        {/* Download Button for Document */}
        <div className="mb-4">
          <p className="font-semibold mb-2">Download Document:</p>
          <a href={serviceDetails.document} className="text-blue-500 hover:underline block mb-2">
