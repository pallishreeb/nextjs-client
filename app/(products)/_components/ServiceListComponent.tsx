       ...
       <Link href="/services/[id]" as="/services/1" legacyBehavior >
          <img className="rounded-t-lg w-full h-full " src={product.img} alt="product thumbnail" />
           ...
           <Link href="/services/[id]" as="/services/1" legacyBehavior >
               ...
               <Link href="/services/[id]" as="/services/1" legacyBehavior >
               <a href="#" className="text-gray-800 dark:text-gray-200  focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-1 py-2 text-center inline-flex items-center">
                   Read more
