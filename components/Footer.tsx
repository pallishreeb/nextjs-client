const Footer: React.FC = () => {
  return (
    <>
      <footer className="bg-gray-900 text-white pt-12 mt-8 pb-8 px-4">
        ...
        <div className=" mt-4 pt-4 text-gray-600 border-t border-gray-800 flex flex-col md:flex-row justify-center items-center">
          <div>© 2024 Kroztek Integrated Solution.</div>
